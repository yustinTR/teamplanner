      ...
      <section className="bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 px-4 pb-16 pt-12">
        <div className="mx-auto max-w-3xl">
          <div className="mb-8 [&_nav]:text-white/60 [&_a]:hover:text-white [&_span]:last:text-white [&_svg]:text-white/30">
            <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Features", href: "/#features" }, { label: "Wedstrijden" }]} />
          </div>
        </div>
      ...
      <section className="bg-white px-4 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            ...
            <Link href="/features/opstellingen" className="rounded-xl border border-neutral-100 bg-neutral-50 p-5 transition-shadow hover:shadow-md">
              <ClipboardList className="size-5 text-primary-600" />
              <h3 className="mt-2 text-sm font-semibold text-neutral-900">Opstellingen</h3>
              <p className="mt-1 text-xs text-muted-foreground">Drag & drop opstellingen met wisselschema</p>
            </Link>
